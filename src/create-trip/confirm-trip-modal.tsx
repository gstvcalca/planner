    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center"> 
            ...
            <div className="space-y-2">
                ...
                To confirm the booking of your trip to <span className="font-semibold text-zinc-100">Threbo, AU</span> on <span className="font-semibold text-zinc-100">Dec 15</span>, please fill the fields below:</p>
            </div>              
